...
| `docs.python` | 19.7 % | 18.0 % | pass |
| `lint.python` | 9.684 | 9.600 | pass |
| `grants.coverage` | 100.0 % | 100.0 % | stale |
| `grants.keys_online` | 100.0 % | 100.0 % | stale |

grants.coverage, grants.keys_online — measured at bb46369b, not at this one. Run `make ci` to take it again.

formats.integration — last run at bb46369b, not at HEAD (afea7272). Run `make test-slow`.
